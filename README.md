<h1 align="center">Zhi Tang</h1>

<p align="center">
  Biomedical Informatics · Computational Immunology · Reproducible Research
</p>
...
浙江大学—爱丁堡大学联合学院生物医学信息学本科生，研究方向为计算免疫学与 TCR 序列分析。
...
- V/J-gene normalization and open-reading-frame checks;
- matched negative sampling and within-individual candidate sets;
- ranking metrics, cross-validation, and residual analysis;
- comparisons with composition-matched decoy β chains;
- remote Linux analysis and reproducible project documentation.
...
- Robust evaluation of machine learning
...
| Project | Focus |
|---|---|
| [Bioinformatics Paper Reading Workflow](https://github.com/Garry-Tang-274/bioinformatics-paper-reading-workflow) | Evidence extraction, close reading, and methodological audit for bioinformatics papers |
| [Windows Remote Research Playbook](https://github.com/Garry-Tang-274/windows-remote-research-playbook) | SSH, VPN, Python environments, GitHub publishing, and layered troubleshooting |
| [Student Calendar Coordinator](https://github.com/Garry-Tang-274/student-calendar-coordinator) | Human-in-the-loop coordination, deduplication, conflict handling, and verified writes |

## Tools

Python · Linux · Git · scikit-learn · ESM2 · SCEPTR
